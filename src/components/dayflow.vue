<template lang="">
  <div>
    ...
    <el-table class="tablist" :data="tableData" max-height="700" style="width: 100%">
      ...
      <el-table-column prop="flow_total" label="流量数新/重">
      </el-table-column>
    ...
    <el-dialog title="流量概况" :visible.sync="dialogTableVisible "  width="40%"  center>
      <el-table :data="gridData"  style="min-height:200px" max-height="400px">
        <el-table-column property="channels" label="渠道名" ></el-table-column>
        <el-table-column property="types" label="类型" ></el-table-column>
        <el-table-column property="repeat" label="流量数新/重"></el-table-column>
      </el-table>
    </el-dialog>
    <div class="block">

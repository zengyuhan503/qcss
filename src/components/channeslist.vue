<template lang="">
  <div>
    ...
    <el-dialog title="填写信息" :visible.sync="editDialogVisible2">
      <div style="width: 100%;position: relative;">
        <el-table :data="infotable" style="width: 100%">
          <el-table-column prop="date" label="日期" width="180">
          </el-table-column>
          <el-table-column prop="name" label="进程数量" width="180">
          </el-table-column>
          <el-table-column prop="address" label="单价">
          </el-table-column>
          <el-table-column prop="address" label="结算金额">
          </el-table-column>
          <el-table-column prop="address" label="实际结算金额">
          </el-table-column>
          <el-table-column prop="address" label="实际结算金额">
            <template slot-scope="scope">
              <el-button @click="handleClickinfo(scope.row)" type="primary" size="small">详情</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
      <span slot="footer" class="dialog-footer">
        <el-button @click="editDialogVisible2=false">关闭</el-button>
      </span>
    </el-dialog>
      ...
      <div style="width: 100%;position: relative;">
        <el-form ref="form" :model="form" label-width="130px">
          ...
          <el-form-item label="下载链接配置">
            <el-input v-model="form.linkconfig"></el-input>
          </el-form-item>

  ...
  <div>
    ...
    <el-dialog title="下载概况" :visible.sync="dialogTableVisible" width="40%"  center>
        <el-table :data="gridData"  style="min-height:200px" max-height="400px">
          ...
          <el-table-column property="downloadtype" label="类型"></el-table-column>
          <el-table-column property="downloadnumber" label="下载数"></el-table-column>
          <el-table-column property="success_fun" label="成功运行数"></el-table-column>
          <el-table-column property="proport" label="运行比例数"></el-table-column>
          <el-table-column property="terminal_number" label="终端数"></el-table-column>
        </el-table>
      </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getstudentlist() {
        ...
        this.axios
          .get("/public/index.php/statiHomeDay", { params: params })
          .then(res => {

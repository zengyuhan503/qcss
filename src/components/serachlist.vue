<template lang="">
    <div>
                        ...
                        <el-col :span="6">
                            <el-form-item label="查询日期">
                                <el-date-picker v-model="timess" type="daterange" range-separator="至"
                                    start-placeholder="开始日期" end-placeholder="结束日期" :default-value="defauleTimes">
                                </el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
        ...
        <el-table class="tablist" :data="tableData" max-height="700" style="width: 100%">
             <el-table-column prop="time" label="兴趣部落新/重"> </el-table-column>
            <el-table-column prop="type" label="空间认证新/重"> </el-table-column>
            <el-table-column prop="flow_total" label="空间达人新/重">
            </el-table-column>
            <el-table-column prop="flow_total" label="校园达人/重">
            </el-table-column>
            <el-table-column prop="flow_total" label="YY直播新/重">
            </el-table-column>
            <el-table-column prop="flow_total" label="CC直播新/重">
            </el-table-column>
            <el-table-column prop="flow_total" label="部落评论新/重">
            </el-table-column>
            <el-table-column prop="flow_total" label="来自渠道">
            </el-table-column>

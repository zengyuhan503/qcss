<template lang="">
    <div>
        ...
        <el-table class="tablist" :data="tableData" max-height="700" style="width: 100%">
            <el-table-column prop="times" label="进程数"> </el-table-column>
            <el-table-column prop="channel_name" label="终端数"> </el-table-column>
            <el-table-column prop="today_process" label="渠道名"> </el-table-column>
            </el-table-column>

<template lang="">
    <div>
                    ...
                    <el-row :gutter="10">
                        <el-col :span="6">
                            <el-form-item label="查询日期">
                                <el-date-picker v-model="form.month" type="daterange" range-separator="至"
        ...
        <el-table class="tablist" :data="tableData" max-height="700" style="width: 100%">
            ...
            <el-table-column prop="downloads" label="下载总数">
            </el-table-column>
            <el-table-column label="运行数">
            ...
            <el-table-column prop="terminals" label="来自渠道">
            </el-table-column>
        </el-table>
        <div class="block">
